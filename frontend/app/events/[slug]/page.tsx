      ...
      <article className="event-detail">
        <div className="event-detail-top">
          ...
          <div className="event-detail-body">
            ...
            <dl>
              <div><dt>Date</dt><dd>{formatEventDate(event.start_at)}</dd></div>
              <div><dt>Time</dt><dd>{formatEventTime(event.start_at)}–{formatEventTime(event.end_at)}</dd></div>
              <div><dt>Venue</dt><dd>{event.venue_name}<br />{event.venue_address}</dd></div>
              <div><dt>Capacity</dt><dd>{event.capacity} guests</dd></div>
            </dl>
          </div>
          </div>
          <BookingForm
